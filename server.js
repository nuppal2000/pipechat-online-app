          ...
          content: [
            {
              type: "input_text",
              text: JSON.stringify({
                task: "Respond as a conversational CRM assistant. Propose a supported CRM action only when the user requests a table, field, layout, view, report or task change. Clarify missing details; explain unsupported requests conversationally.",
