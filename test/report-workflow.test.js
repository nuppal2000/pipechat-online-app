...
function harness(replies){
  ...
  const context={window:{PipeChatSchema:require('../public/table-schema.js'),PipeChatInspector:require('../public/inspector-core.js'),PipeChatTodo:require('../public/todo-core.js'),PipelineCore:C,PipeChatCustomize:require('../public/workspace-customization.js'),PipeChatIcons:{},Chart,messages},Chart,document:{getElementById:node,querySelector:node},AbortSignal,
